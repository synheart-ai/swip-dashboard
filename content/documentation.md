...
| Purpose | URL |
|---------|-----|
| Dashboard UI | `https://dashboard.swip.app` |
| REST API base | `https://dashboard.swip.app/api` |
...
Base URL: `https://dashboard.swip.app/api/v1`
...
```bash
curl -X GET "https://dashboard.swip.app/api/v1/app_sessions?app_id=com.synheart.focus&limit=25" \
...
- Dashboard: https://dashboard.swip.app  
- Developer Portal: https://dashboard.swip.app/developer  
