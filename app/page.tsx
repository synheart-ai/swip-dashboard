      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className="text-center pt-20 pb-16 min-h-screen flex flex-col items-center justify-center">
          ...
          <p className="md:text-xl text-base text-gray-300 md:max-w-3xl max-w-2xl mx-auto mb-12 leading-relaxed">
            Measure real wellness impact with HRV and emotion-aware metrics. The
            SWIP Dashboard pairs a public transparency layer with the
            <strong className="text-purple-200">
              {" "}
              SWIP Flutter SDK
            </strong> and{" "}
            <strong className="text-purple-200">Synheart Wear SDK</strong> so
            you can build production wellness apps, ingest biosignals, and
            certify outcomes.
          </p>
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-300 leading-relaxed mb-6">
                The open-source <strong>SWIP Flutter SDK</strong> packages
                biosignals, sessions, and emotions for ingestion. Pair it with
                the <strong>Synheart Wear SDK</strong> to collect data from
                popular wearables and unlock verified ingestion once your app is
                approved.
              </p>
              <ul className="space-y-3 text-gray-300">
                ...
                <li className="flex items-center gap-3">
                  ...
                  Synheart Wear plugin streaming Apple Watch, Fitbit, Garmin,
                  Whoop, and more.
                </li>
                <li className="flex items-center gap-3">
                  <svg
...
Future<void> main() async {
  ...
  debugPrint('Wellness Impact Score: \${results.wellnessScore}');
                ...
                <p className="text-gray-400 text-sm mt-4">
                  Request ingestion access in the developer portal to receive
                  your ingestion key and unlock the full Flutter + Synheart Wear
                  pipeline.
                </p>
              </div>
            </div>
        ...
        <div className="relative overflow-hidden rounded-3xl border border-purple-500/20 bg-gradient-to-br from-purple-900/20 via-slate-900/40 to-pink-900/20 p-6 md:p-16 md:mb-20 mb-8 backdrop-blur-sm">
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-6 gap-12 ">
            <div className="col-span-3">
              ...
              <p className="text-gray-300  leading-relaxed mb-6">
                Our Flutter-first SDK stack lets you stream biosignals from
                wearables, compute SWIP scores, and deliver verified ingestion
                directly to the dashboard. Ready-to-use widgets, validation
                helpers, and certification tooling make wellness-grade telemetry
              ...
              <div className="grid grid-cols-1 mt-6  gap-3 mb-4">
                <div className="rounded-2xl border border-purple-500/20 bg-black/30 p-5">
                  ...
                  <p className="text-gray-400 text-sm leading-relaxed">
                    Flutter package with Bloc-friendly APIs, session lifecycle
                    helpers, and SWIP certification workflows.
                  </p>
                  <a
                    href="https://github.com/synheart-ai/swip"
                    target="_blank"
                ...
                <div className="rounded-2xl border border-blue-500/20 bg-black/30 p-5">
                  ...
                  <p className="text-gray-400 text-sm leading-relaxed">
                    Flutter plugin that abstracts BLE/Web APIs for Apple Watch,
                    Fitbit, Garmin, Whoop, and more—streamlined into the SWIP
                    pipeline.
                  </p>
                  <a
                    href="https://github.com/synheart-ai/synheart-wear"
...
Future<void> startWearStream() async {
  ...
  synheart.streamHRV(windowSize: const Duration(seconds: 5)).listen((packet) {
    ...
    debugPrint('HRV RMSSD: \$hrv');
                ...
                <p className="text-gray-400 text-sm mt-4">
                  Synheart Wear streams biosignals directly into the SWIP
                  Flutter SDK so your app can publish verified telemetry in real
                  time.
                </p>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:mb-20 mb-8">
          ...
          <div className="group relative overflow-hidden rounded-2xl border border-gray-800 bg-gradient-to-br from-gray-900/50 to-gray-900/30 p-8 backdrop-blur-sm hover:border-purple-500/50 transition-all">
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-400 leading-relaxed">
                Browse anonymized session data and view the global leaderboard
                ranking apps by their wellness impact scores.
              </p>
            </div>
          </div>
          ...
          <div className="group relative overflow-hidden rounded-2xl border border-gray-800 bg-gradient-to-br from-gray-900/50 to-gray-900/30 p-8 backdrop-blur-sm hover:border-pink-500/50 transition-all">
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-400 leading-relaxed">
                Register your wellness app, generate API keys, and submit
                session data for automatic SWIP evaluation.
              </p>
            </div>
          </div>
          ...
          <div className="group relative overflow-hidden rounded-2xl border border-gray-800 bg-gradient-to-br from-gray-900/50 to-gray-900/30 p-8 backdrop-blur-sm hover:border-blue-500/50 transition-all">
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-400 leading-relaxed">
                Reproducible wellness research through open metrics, transparent
                data structures, and community contributions.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <StatsCard
              ...
              trend={{
                ...
                label: "This Month",
                positive:
                  parseFloat(stats.apiCallsGrowth.replace("%", "")) >= 0,
              }}
            />
            <StatsCard
              ...
              trend={{
                ...
                label: "Growth",
                positive:
                  parseFloat(stats.uptimeImprovement.replace("%", "")) >= 0,
              }}
            />
            <StatsCard
              title="System Uptime"
        ...
        <div className="relative overflow-hidden rounded-3xl border border-gray-800 bg-gradient-to-br from-purple-900/20 to-pink-900/20 p-12 md:p-16 md:mb-20 mb-8 backdrop-blur-sm">
          ...
          <div className="relative z-10 text-center">
            ...
            <p className="text-gray-300 text-lg mb-8 max-w-2xl mx-auto">
              Join hundreds of developers building transparent, data-driven
        ...
        <footer className="border-t border-gray-800 py-12">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between pt-8 border-t border-gray-800">
            ...
            <p className="text-gray-500 text-sm">
              Built with <span className="text-pink-400">❤</span> for wellness
              transparency
            </p>
          </div>
        </footer>
