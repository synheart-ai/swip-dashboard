...
export function RegisterAppPanel({
  ...
  const handleFetchMetadata = async () => {
    ...
    try {
      ...
      setError(
        err.message || "Could not fetch app metadata. Please fill in manually.",
      );
    } finally {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!contentType || !contentType.includes("application/json")) {
        throw new Error(
          "Invalid response from server. Please ensure you are logged in.",
        );
      }
  ...
  return (
    <>
      ...
      {/* Sliding Panel */}
      <div className="fixed top-0 right-0 h-full w-full max-w-2xl !mt-0 bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 shadow-2xl z-50 transform transition-transform duration-300 ease-out overflow-y-auto border-l border-gray-800">
        {/* Header */}
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-purple-100 text-sm">
                  Connect your application to the SWIP platform
                </p>
              </div>
            </div>
            <button
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-2">
                    Select the platform your app runs on
                  </p>
                </div>
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    ...
                    {formData.os &&
                      formData.appId &&
                      (formData.os === "android" || formData.os === "ios") && (
                        <button
                          type="button"
                  ...
                  <p className="text-xs text-gray-500 mt-2">
                    {formData.os === "android" &&
                      "Enter package name (e.g., com.example.myapp)"}
                    {formData.os === "ios" &&
                      "Enter bundle ID (e.g., com.company.appname)"}
                    {!formData.os &&
                      "Package name for Android, Bundle ID for iOS"}
                  </p>
                </div>
